 ...
 */
public class DSRRequestMessageGenerator {
    ...
    public static String getMessage(String srcIP, int srcPort,
        ...
        return String.format("%s_%d_%s:%d-%s:%d-%d|%s", msgContent, seq++,
                                                  srcIP, srcPort,
                                                  dstIP, dstPort,
                                                  ms, srcIP);
    }

    public static String getDataMessage(String srcIP, int srcPort,
                                        String dstIP, int dstPort,
                                        String msgContent, String routes) {
        long ms = Calendar.getInstance().getTimeInMillis();
